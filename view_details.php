...
<head>
  ...
  <title>Indilet - <?php echo htmlspecialchars($property['description'] ?? 'Property Details'); ?></title>
...
<body>
  ...
  <!-- WhatsApp Float -->
  <a href="https://wa.me/+919381226619" target="_blank" class="whatsapp-float">
  ...
  <div class="container">
    <div class="property-card">
      ...
      <div class="contact-section">
        <h2 class="contact-title">Interested in this property?</h2>
        <div class="contact-buttons">
          <a href="https://wa.me/+918522863853?text=Hi%2C%20I%27m%20interested%20in%20the%20property%3A%20<?php echo urlencode($property['description']); ?>%20-%20<?php echo formatPrice($property['rent']); ?>%20per%20month" 
             target="_blank" class="contact-btn whatsapp">
            <i class="fab fa-whatsapp"></i>
            WhatsApp
          </a>
          <a href="tel:+918522863853" class="contact-btn call">
